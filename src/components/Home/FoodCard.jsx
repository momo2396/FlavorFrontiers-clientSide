        ...
        <div className="flex justify-between pb-4 border-bottom">
          <div className="flex items-center">
            <h2 className="text-base font-bold">
              Food Category:{" "}
              <span className=" text-red-900">{food?.food_category}</span>
            </h2>
          </div>
          <h2 className="text-base font-bold">
            Quantity: <span className=" text-red-900">{food?.quantity}</span>
          </h2>
        </div>
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-xl font-semibold text-white">
              Origin: <span>{food?.food_origin}</span>
            </p>
            <p className="text-xl font-semibold text-white">
              Price: $<span>{food?.price_in_dollars}</span>
            </p>
            <p className="leadi text-white pt-3 text-lg">
